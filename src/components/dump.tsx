            ...
            <div className=' w-[60%]'>
                ...
                <div className='my-12 '>
                    <div className="title flex  gap-3 items-center  mb-6  ">
                        <div className=' ml-[-50px] sticky top-0 z-30'> <Receive width={32} height={32} className='text-primary bg-lightbg w-10 h-10 p-1 rounded-lg border-lightstrip border-[0.5px] shadow-custshadow2'/></div>
                ...
                <div className='my-12'>
                    <div className="title flex gap-3  items-center w-[25%] mb-6 ">
                        <div className=' ml-[-50px]'> <Receive width={32} height={32} className='text-primary bg-lightbg w-10 h-10 p-1 rounded-lg border-lightstrip border-[0.5px] shadow-custshadow2'/></div>
